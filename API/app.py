...
mlflow.set_tracking_uri("https://sheyko-mlflow-server-ft34.hf.space")
MLFLOW_TRACKING_URI = "https://sheyko-mlflow-server-ft34.hf.space"
...
Welcome to demo API. This app is made for you to understand how FastAPI works! Try it out 🕹️
...
async def predict(req : Item):
    ...
    logged_model = "models:/Greedy_model@challenger"
